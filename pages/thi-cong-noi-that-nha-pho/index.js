...
import ArticlePage from '../../components/tantruonggiang/ArticlePage';
...
export default function ThiCongNoiThatGoCongNghiep({ relatedPosts }) {
  ...
  return (
    <DefaultLayout>
      <Head>
        <title>Thi Công Nội Thất Gỗ Công Nghiệp Cho Chung Cư – Giải Pháp Hiện Đại Và Tiết Kiệm</title>
        <meta
          name="description"
          content="Khám phá quy trình thi công nội thất gỗ công nghiệp cho chung cư với chi phí hợp lý, mẫu mã đa dạng và độ bền cao. Tìm hiểu ngay cách lựa chọn đơn vị uy tín!"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://yourdomain.com/thi-cong-noi-that-go-cong-nghiep" />
        {/* Open Graph Meta */}
        <meta property="og:title" content="Thi Công Nội Thất Gỗ Công Nghiệp Cho Chung Cư – Giải Pháp Hiện Đại Và Tiết Kiệm" />
        <meta
          property="og:description"
          content="Khám phá quy trình thi công nội thất gỗ công nghiệp cho chung cư với chi phí hợp lý, mẫu mã đa dạng và độ bền cao. Tìm hiểu ngay cách lựa chọn đơn vị uy tín!"
        />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://yourdomain.com/thi-cong-noi-that-go-cong-nghiep" />
        <meta property="og:image" content="https://yourdomain.com/images/hero-nha-thiet-ke.jpg" />
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Thi Công Nội Thất Gỗ Công Nghiệp Cho Chung Cư – Giải Pháp Hiện Đại Và Tiết Kiệm" />
        <meta
          name="twitter:description"
          content="Khám phá quy trình thi công nội thất gỗ công nghiệp cho chung cư với chi phí hợp lý, mẫu mã đa dạng và độ bền cao. Tìm hiểu ngay cách lựa chọn đơn vị uy tín!"
        />
        <meta name="twitter:image" content="https://yourdomain.com/images/hero-nha-thiet-ke.jpg" />
      </Head>
      ...
      <div className="relative w-full h-[30vh] md:h-[40vh]">
        ...
        <div className="absolute bottom-6 left-0 md:bottom-8 md:left-8 right-0 flex flex-col justify-end items-start text-white px-6 md:px-10 lg:px-16 pb-3">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-white">
            Thi Công Nội Thất Gỗ Công Nghiệp Cho Chung Cư
          </h1>
