          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div ref={leftSectionRef} className="opacity-0 md:block hidden">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Biến không gian sống thành tuyệt tác với Nội Thất Tân Trường Giang
              </h3>
              <p className="text-lg text-gray-600">
                Nội Thất Tân Trường Giang tự hào mang đến những giải pháp thiết kế nội thất tinh tế, sang trọng và cá nhân hóa cho từng khách hàng.
              </p>
              <p>Liên hệ ngay hôm nay để nhận tư vấn miễn phí từ đội ngũ chuyên gia của chúng tôi!</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Yêu cầu tư vấn của bạn (ví dụ: thiết kế nội thất phòng khách, tủ bếp hiện đại...)"
