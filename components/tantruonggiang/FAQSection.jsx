...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    {
      question: "Nội thất của Tân Trường Giang có thân thiện với môi trường không?",
      answer:
    ...
    {
      question: "Tân Trường Giang có cung cấp dịch vụ tư vấn thiết kế không?",
      answer:
    ...
    {
      question: "Chính sách bảo hành nội thất của Tân Trường Giang như thế nào?",
      answer:
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="relative h-48 rounded-lg overflow-hidden mb-4">
              <Image
                src="/banner2.jpg"
                alt="Nội thất Tân Trường Giang Showroom"
                layout="fill"
                objectFit="cover"
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Tân Trường Giang cam kết mang đến không gian sống hoàn hảo với các
